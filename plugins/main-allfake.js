...
handler.all = async function (m) {
  ...
  global.creador = 'Wa.me/51939467706'
  global.ofcbot = `${conn?.user?.jid?.split('@')[0] || ''}`
  global.asistencia = 'Wa.me/51928567606'
  global.namechannel = '⏤͟͞㋡ CREEPER🤖 '
  global.namegrupo = ' Tiempo FS☘︎'
  global.namecomu = '𝗖𝗼𝗺𝘂𝗻𝗶𝗱𝗮𝗱 ⏤͟͞ 𝐓𝐇𝐄 Tiempo'
  global.listo = '⚔️ *Aquí tienes perra*'

  //Ids channel
  global.canalIdM = ["120363419782804545@newsletter", "120363419782804545@newsletter"]
  global.canalNombreM = ["⏤͟͞㋡ 𝐓𝐇𝐄 Tiempo ", "㋡ 𝐓𝐇𝐄 Tiempo"]
  global.idchannel = canalIdM[0] //CREEPER
  ...
  let canal2 = 'https://whatsapp.com/channel/0029VbBcXc8Chq6GmExvhU1l'
  var git = 'https://github.com/hello-000-1' 
  var youtube = '' 
  var github = 'https://github.com/hello-000-1' 
  let correo = 'elvissihuinferro2025@gmail.com'
  ...
  global.icono = pickRandom([
    'https://files.catbox.moe/pf7ytb.jpg',
  ])

  global.rcanal = { contextInfo: { isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, serverMessageId: 100, newsletterName: channelRD.name }, externalAdReply: { showAdAttribution: true, title: "CREEPER🤖 ☘", body: "ELVIS SF", mediaUrl: null, description: null, previewType: "PHOTO", thumbnailUrl: icono, sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false }, } }
